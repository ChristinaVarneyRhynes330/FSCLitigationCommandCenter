    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-gray-900 mb-4">Litigation Command Center</h1>

          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
            Enterprise-grade legal case management platform. Streamline
            litigation workflows, collaborate with AI legal assistants, and
            maintain complete oversight from discovery through trial.
          </p>

          <button onClick={onEnter} className="btn btn-primary mt-2">
        ...
        <div className="grid grid-cols-2 gap-6 mb-16">
          <div className="card">
            <div className="card-body">
              ...
              <p className="text-gray-600 mb-4">
                Comprehensive deadline tracking, task management, and case
                timeline visualization. Never miss a critical filing deadline.
              </p>
          ...
          <div className="card">
            <div className="card-body">
              ...
              <p className="text-gray-600 mb-4">
                Access specialized AI assistants for case strategy, legal
                research, motion drafting, and cross-examination preparation.
              </p>
              <div className="flex items-center gap-2 text-sm text-teal">
                <div className="w-1.5 h-1.5 rounded-full bg-teal" />
          ...
          <div className="card">
            <div className="card-body">
              ...
              <p className="text-gray-600 mb-4">
                Organized document repository with Bates stamping, metadata
          ...
          <div className="card">
            <div className="card-body">
              ...
              <p className="text-gray-600 mb-4">
                Integrated conferral logging, hearing mode, and team
                coordination features for seamless litigation management.
              </p>
              <div className="flex items-center gap-2 text-sm text-teal">
                <div className="w-1.5 h-1.5 rounded-full bg-teal" />
                Multi-user support
        ...
        {showPalette && (
          <ColorPaletteShowcase onClose={() => setShowPalette(false)} />
        )}
      </div>
    </div>
  );
